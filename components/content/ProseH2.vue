<template>
  ...
  >
    <div
      :class="
        cn(
          'xs:pl-14 xs:mx-0 xs:bg-transparent xs:backdrop-none xs:shadow-none -mx-4 flex h-[var(--ui-header-height)] items-center bg-white/75 px-4 text-lg opacity-0 shadow-xl backdrop-blur duration-500 motion-safe:transition-opacity sm:pl-14 md:pl-0 dark:bg-neutral-800/75',
          {
