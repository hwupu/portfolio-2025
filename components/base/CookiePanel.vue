          ...
          <div class="space-y-2">
            ...
            <Collapsible v-slot="{ open }">
              <CollapsibleTrigger class="flex items-center gap-2 text-base"
                ...
                <Icon
                  :name="
                    open ? 'fa6-solid:angles-up' : 'fa6-solid:angles-down'
                  "
              /></CollapsibleTrigger>
              <CollapsibleContent class="py-4">
                <ul class="space-y-2">
                  <li class="flex gap-2">
                    <div>
                      <Switch id="func" :default-value="true" disabled />
                    </div>
                    <div>
                      ...
                      <p v-else class="text-muted-foreground text-sm">
                        These cookies are set to provide the service,
                        application or resource requested. Without these
                        cookies, your request cannot be properly delivered. They
                        are usually set to manage actions made by you, such as
                        requesting website visual elements, pages resources or
                        language preferences. We can also use these cookies to
                        set up essential functionalities to guarantee the
                        security and efficiency of the service requested, like
                        CORS protection.
                      </p>
                    </div>
                  </li>
                  <li class="flex gap-2">
                    ...
                    <div>
                      ...
                      <p v-else class="text-muted-foreground text-sm">
                        These cookies are set to provide quantitative measures
                        of website visitors. Information collected with these
                        cookies is used in operations to measure website or
                        software KPIs, such as performance. With the usage of
                        these cookies we are able to count visits and traffic
                        sources to improve the performance of our site and
                        application. If you do not allow these cookies, we will
                  ...
                  <li class="flex gap-2">
                    ...
                    <div>
                      ...
                      <p v-else class="text-muted-foreground text-sm">
                        These cookies are set by our analytics partners to
                        provide behavioral analytical data. They collect any
                        type of browsing information necessary to create
                        profiles and to understand user habits in order to
                        develop an individual and specific advertising routine.
                        The profile created regarding your browsing interest and
                        behavior is used to customize the ads you see when you
